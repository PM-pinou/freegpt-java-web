 ...
 * 调用chat-gpt3模型的 随便玩
 */
@Component(UserLevelConstant.PERMANENT_USERS + ModelServiceTypeConstant.CHAT_NET_GPT_MODEL3)
public class PermanentUserChatGptUserServiceTypeRuleNET3 implements UserServiceTypeRule<UserLevelAccessVo> {
