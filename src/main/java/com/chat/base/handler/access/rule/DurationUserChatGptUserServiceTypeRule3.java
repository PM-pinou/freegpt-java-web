 ...
 */
@Component(UserLevelConstant.DURATION_USER + ModelServiceTypeConstant.CHAT_GPT_MODEL3)
public class DurationUserChatGptUserServiceTypeRule3 implements UserServiceTypeRule<UserLevelAccessVo> {
