...
import com.chat.base.bean.gpt.ChoiceMessage;
import com.chat.base.bean.gpt.GptTurbo;
import com.chat.base.bean.gpt.OpenReq;
...
public class ChatGptUtils {
    ...
    public static String chatWithSangiu(String systemDesc, String message) throws Exception {
        ...
        map.put("Authorization", "Bearer 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");

        String url = "https://www.liulinlin.top/openai/v1/chat/completions";
