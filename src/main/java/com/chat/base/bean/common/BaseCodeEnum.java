...
public enum BaseCodeEnum implements BaseCode {
    ...
    NO_VISITS_NUMBER(1002,"您的访问次数已经达到上限，请联系客服,获取更多访问次数 " +
            " ![FreeGPT]( "+ CommonConstant.OFFICIAL_ACCOUNT +" ) "),
    LOGIN_EXPIRE(1001, "blueCat-login-expire"),
    HAVE_FILTER_WORD(1003, "问题中包含保存违规信息，请重新编辑！,如果有疑惑~  请联系： ![FreeGPT]( https://blog.hi-cat.top/wp-content/uploads/2023/10/添加.jpg )"),
    IP_LIMIT_MSG(1006,"您好，不好意思！为防止接口被刷次数，登录账号即可重新访问！"),
    VISIT_BUZY(1008,"您好，不好意思！为防止接口被刷次数，发现您现在访问过于频繁，请等待三秒再进行访问！"),
    BACKLIST(1009,"您好，检测到您近期有异常，暂被限制使用，有疑惑可以添加客服微信联系到我们！"),
    ...
    NO_MONEY(1014,"您好,余额不够，请联系管理员！ ![FreeGPT]( https://blog.hi-cat.top/wp-content/uploads/2023/10/添加.jpg )"),
